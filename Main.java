...
public class Main{
    ...
    static final String FILE_NAME = "updatedrecords1.txt";
            ...
            try{
                ...
                switch (choice) {
                    ...
                    case 0:
                        ...
                        break;
                    default:
                        System.out.println("Copy Rights Reserved - 2023");
                        validInput = true;
                }
            } catch (Exception e){
    ...
    public static void pointsTable(){
        String[][] teams = {
                ...
                {"Chelsea", "Thomas Tuchel", "Cesar Azpilicueta", "38", "23", "9", "6", "75"},
                {"Leicester City", "Brendan Rodgers", "Kasper Schmeichel", "38", "20", "6", "12", "66"},
                //Further Addition: add other records once the program is completed:
        };
    ...
    public static void teamMenu() {
        ...
        //System.out.println("===========================================================================================");
        System.out.printf("\t\t\t\t\t\t\t\t\t\t+--------------------------------------+\t\t\t\t\t\t\t\t\t\t\n");
        System.out.printf("\t\t\t\t\t\t\t\t\t\t| Note: You might need admin access to |\t\t\t\t\t\t\t\t\t\t\n");
        ...
        try {
            ...
            System.out.println("InputOutput Exception Triggered!");
            teamMenu();
        }
    }
    ...
    public static void adminAccessAddRecords() {
        for (int i = 0; i < 3; i++) {
            try {
                ...
                if(idNum.equals(IDNUM) && password.equals(PASSWORD)){ //we donot use ignorecase in this for security!
                    System.out.println("\t\t\tLogin Successful\t\t\t");
                    addRecord();
                    break;
                }
                else{
                    System.out.println("INCORRECT ID NUMBER OF PASSWORD!\n");
                    System.out.printf("You only have %d tries left.", 2-i);
                }
            } catch (Exception e) {
    ...
    public static void loadRankings() {
        ...
        rankCount = 0;
        try (BufferedReader readRank = new BufferedReader(new FileReader(Rankings.txt))) {
            String rankLine;
